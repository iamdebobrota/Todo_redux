...
import { deleteTodosData, editTodosData, getTodosData, postTodosData } from "../redux/todos/action";
...
( 
  todos && todos.map((it)=>(
    <div key={it.id} style={{background:'lightGreen', width:'300px', margin:'auto', marginBottom:'20px'}}>
     {edit!==it.id ? <h3>{it.name}</h3> :
      <input type='text' name="name" placeholder='edit here..'
